...
class FakeRecommendableOffersRaw(Base):
    ...
    booking_number_last_7_days = Column(Integer)
    booking_number_last_14_days = Column(Integer)
    booking_number_last_28_days = Column(Integer)
    semantic_emb_mean = Column(Float)
