...
class RecommendableOffersRawExample(BaseModel):
    ...
    booking_number_last_7_days: int = 0
    booking_number_last_14_days: int = 0
    booking_number_last_28_days: int = 0
    semantic_emb_mean: float = 1.0
    total_offers: int = 1
...
movie_offer_paris = RecommendableOffersRawExample(
    ...
    is_geolocated=True,
    booking_number=5,
    booking_number_last_7_days=3,
    booking_number_last_14_days=1,
    booking_number_last_28_days=1,
...
movie_offer_high_price_paris = RecommendableOffersRawExample(
    ...
    booking_number=7,
    booking_number_last_7_days=3,
    booking_number_last_14_days=2,
    booking_number_last_28_days=2,
    semantic_emb_mean=1.0,
    venue_latitude=iris_paris_chatelet.latitude,
    venue_longitude=iris_paris_chatelet.longitude,
