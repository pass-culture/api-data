...
class EnrichedUser(Base):
    ...
    user_birth_date: sa_orm.Mapped[datetime | None] = sa_orm.mapped_column(DateTime(timezone=False))
    user_deposit_creation_date: sa_orm.Mapped[datetime | None] = sa_orm.mapped_column(DateTime(timezone=False))
