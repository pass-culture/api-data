    ...
    for item_id, cached_offer in cache_hits.items():
        ...
        resolved_offers.append(
            EnrichedRecommendableOffer(
                ...
                retrieval_vector_column=item_data.retrieval_vector_column,
                retrieval_model_name=item_data.retrieval_model_name,
                retrieval_model_version=item_data.retrieval_model_version,
        ...
        if not item.is_geolocated or item.total_offers == 1:
            ...
            fast_track_enriched_offers.append(
                EnrichedRecommendableOffer(
                    ...
                    retrieval_vector_column=item.retrieval_vector_column,
                    retrieval_model_name=item.retrieval_model_name,
                    retrieval_model_version=item.retrieval_model_version,
